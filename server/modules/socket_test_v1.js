...
module.exports = function(app,io){
    io.on('connection', function(socket){
        ...
        socket.on('vAnswer',function(data,fn){
            console.log("VAnswer is call from unity game");
            console.log(JSON.stringify(data));
            //body.iQuestionId,body.iAnswerId
            queries.check_question_answer({"iQuestionId":data.iQuestionId,"iAnswerId":data.iAnswerId},function(err,res1){
