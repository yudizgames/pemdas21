angular.module('client').controller('ClientUsersCtrl',function ($scope,$rootScope,$resource,$http,$state,toastr,DTOptionsBuilder,DTColumnDefBuilder,DTColumnBuilder,$compile) {
    ...
    $scope.userOperation = function(iUserId,OperationType){
        ...
        if(OperationType == 'view'){
            ...
            $state.go('client.userform',{'id':iUserId,'action':'Edit'});
        }
