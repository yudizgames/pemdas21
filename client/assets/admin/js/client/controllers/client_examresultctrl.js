angular.module('client').controller('ClientExamresultCtrl',function ($scope,$rootScope,$resource,$http,$state,$stateParams) {
    console.log("Client Exam User Controller call");
