angular.module('main').controller('ClientUsersFormCtrl',function ($scope,$rootScope,$state,$stateParams,$resource,$http,toastr){
    console.log("User Form Ctrl Under Client");
